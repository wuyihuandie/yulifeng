...
$(function () {
    $("#title").text((!getUrlValue('qytitle'))?"":getUrlValue('qytitle'));
    ...
    layui.use('table', function(){
        ...
        table.on('row(test)', function(obj){
            if(obj.data.INDUSTRY=='NK01'){
                ...
                window.location.href=realPath+"view/qyyxjc/yxjc-2.html?menuType=2&PRIPID="+encodeStr(obj.data.PRIPID)+"&KEYNO="+encodeStr(obj.data.KEYNO);
            }
        });
        ...
        $("#exports").click(function () {
            ...
            doData(BASE_URL + '/entHomePage/getGsqyList2',params,function (result) {
                if(result.status = "10001"){
                    ...
                    exportData.unshift({ENTNAME: '企业名称',CODE_NAME:'国民经济行业分类',AREA_NAME:'所属区域',REGCAP:'注册资金(万元)',ESTDATES:'成立日期',VENDINC:'营业收入(万元)',DATAGROWTH:'营收增速',ENTTYPE_CN:'企业类型',UNISCID: '统一社会信用代码'});
