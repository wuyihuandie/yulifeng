...
$(function () {
    ...
    ESTDATEMONTH=getUrlValue('ESTDATEMONTH');//月份新增
    ESTDATEYEAR=getUrlValue('ESTDATEYEAR');//年份新增
    ...
    layui.use('table', function(){
        ...
        tableIns = table.render({
            elem: '#demo'
            ,url: BASE_URL + '/entHomePage/getCompanyDetailsList'//数据接口
       ...
       $("#exports").click(function () {
           ...
           doData(BASE_URL + '/entHomePage/getCompanyDetailsList2',params,function (result) {
                if(result.status = "10001"){
                    var exportData=result.data;
                    exportData.unshift({ENTNAME: '企业名称',CODE_NAME:'国民经济行业分类',AREA_NAME:'所属区域',REGCAP:'注册资金(万元)',ESTDATES:'成立日期',NAME:'法人姓名',NL:'法人年龄',ENTTYPE_CN:'企业类型',UNISCID: '统一社会信用代码'});
