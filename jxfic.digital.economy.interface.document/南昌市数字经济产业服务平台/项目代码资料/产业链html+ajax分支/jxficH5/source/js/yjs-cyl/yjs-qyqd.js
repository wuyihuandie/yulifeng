...
function renderQYList(dataList){
    ...
    dataList.map(function(item,index){
        var isexist = (item.LEVEL_NAME).indexOf(",");
        var LEVEL_NAME="";
        if(isexist==-1){
            LEVEL_NAME=item.LEVEL_NAME;
        }else{
            LEVEL_NAME=(item.LEVEL_NAME).substring(0,isexist)
        }
        var itemHtml=`
                    <tr>
                        ...
                        <td class="td6">`+LEVEL_NAME+`</td>
                        <td class="td8">${!!item.APPLICATION_NAME?item.APPLICATION_NAME:'-'}</td>
                        <td class="td9">${!!item.YJS_VENDINC?item.YJS_VENDINC:'-'}</td>
                        <td class="td10">${!!item.YJS_RATGRO?item.YJS_RATGRO:'-'}</td>
                    </tr>`;
        listHtml+=itemHtml;
    })
            ...
            result.data.forEach(function(item,index){
                listHtml+=`
                    <tr>
                        ...
                        <td class="td8" style="width: 3%;">${item.LEVEL_NAME}</td>
            ...
            result.data.forEach(function(item,index){
                ...
                listHtml+=`
                    <tr>
                        ...
                        <td class="td3" style="width: 82%;text-align:left">${item.CONTENT}</td>
