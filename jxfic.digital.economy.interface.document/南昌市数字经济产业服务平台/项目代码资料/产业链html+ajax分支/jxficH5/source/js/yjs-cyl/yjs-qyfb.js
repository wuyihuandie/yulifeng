$(function(){
	// 物联网
	$('#wlw').click(function(){
		window.location.href = '../cyl-3/cyl-qyfb.html?menuType=5';
	})
...
function queryEntList(area_name) {
	if(getCookie("area_value")==360100||getCookie("area_name")==area_name) {
		...
		layer.open({
			...
			title: false, //不显示标题
			area: ['100%', '100%'], //宽高
			content: realPath + "view/yjs-cyl/yjs-cyl-qyfbEntList.html?YEAR=" + YEAR
...
function queryList(param,ths) {
 ...
 // 点击出现公司弹框
 // var qyfbDom=document.getElementById("qyfbDom");
