...
$(function () {
    ...
    layui.use('table', function(){
        ...
        tableIns = table.render({
            elem: '#demo'
            ,url: BASE_URL + '/entHomePage/getGsqyForcastList'//数据接口
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'VENDINC', title: '预测营收(万元)',sort: true, templet: function(res) {
                ...
                ,{field: 'DATAGROWTH', title: '预测增速（%）',sort: true, templet: function(res) {
        ...
        $("#exports").click(function () {
            ...
            doData(BASE_URL + '/entHomePage/getGsqyForcastList2',params,function (result) {
                if(result.status = "10001"){
                    var exportData=result.data;
                    exportData.unshift({ENTNAME: '企业名称',CODE_NAME:'国民经济行业分类',AREA_NAME:'所属区域',REGCAP:'注册资金(万元)',ESTDATES:'成立日期',VENDINC:'预测营收(万元)',DATAGROWTH:'预测增速（%）',ENTTYPE_CN:'企业类型',UNISCID: '统一社会信用代码'});
                    LAY_EXCEL.exportExcel(exportData,"规上企业预测营收列表.xlsx", "xlsx", {
                        extend: {
                            '!cols': colConf
                        }
                    });
