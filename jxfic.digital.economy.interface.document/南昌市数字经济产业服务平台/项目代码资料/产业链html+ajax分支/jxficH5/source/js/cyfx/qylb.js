...
$(function () {
    ...
    layui.use('table', function(){
        ...
        tableIns = table.render({
            elem: '#demo'
            ,url: BASE_URL + '/industryDistributionController/getCompanyDetailsList'//数据接口
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'VENDINC',width:'7%', title: '营业收入(万元)',sort: true, templet: function(res) {
                ...
                ,{field: 'RATGRO',width:'7%', title: '纳税额(万元)',sort: true, templet: function(res) {
                        if(res.RATGRO!=undefined&&res.RATGRO!='undefined'){
                            return res.RATGRO.toFixed(2);
                        }else{
                            return "";
                        }
       ...
       $("#exports").click(function () {
           ...
           doData(BASE_URL + '/industryDistributionController/getCompanyDetailsList2',params,function (result) {
               if(result.status = "10001"){
                   var exportData=result.data;
                   exportData.unshift({ENTNAME: '企业名称',CODE_NAME:'国民经济行业分类',AREA_NAME:'所属区域',REGCAP:'注册资金(万元)',ESTDATES:'成立日期',VENDINC:'营业收入(万元)',RATGRO:'纳税额(万元)',ENTTYPE_CN:'企业类型',UNISCID: '统一社会信用代码'});
