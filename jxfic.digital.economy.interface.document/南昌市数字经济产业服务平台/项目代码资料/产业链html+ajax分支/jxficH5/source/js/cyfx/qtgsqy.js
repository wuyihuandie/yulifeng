...
$(function () {
    ...
    layui.use('table', function(){
        ...
        tableIns = table.render({
            ...
            ,limit:20
            ,cols: [[ //表头
                {type:'numbers',width:'5%', title: '序号',sort: true}
                ,{field:'ENTNAME',  title: '企业名称',sort: true}
                ,{field:'CODE_NAME',  title: '国民经济行业分类',sort: true}
                ,{field: 'WHML', title: '归属到其他行业'}
                ,{field:'AREA_NAME', width:'8%', title: '所属区域',sort: true}
                ,{field:'REGCAP',width:'9%', title: '注册资金（万元）',sort: true}
                ,{field:'ESTDATES', width:'7%', title: '成立日期',sort: true}
       ...
       $("#exports").click(function () {
           ...
           doData(BASE_URL + '/industryDistributionController/getCompanyDetailsList2',params,function (result) {
               if(result.status = "10001"){
                   ...
                   exportData.unshift({ENTNAME: '企业名称',CODE_NAME:'国民经济行业分类',WHML:'归属到其他行业',AREA_NAME:'所属区域',REGCAP:'注册资金(万元)',ESTDATES:'成立日期',ENTTYPE_CN:'企业类型',UNISCID: '统一社会信用代码'});
