...
$(function () {
    ...
    YEAR=getUrlValue('YEAR');//年份新增
    time_date=(!getUrlValue('time_date'))?'':getUrlValue('time_date');//年月参数
    TZLY_CODENAME=getUrlValue('TZLY_CODENAME');//来源国家
    ...
    layui.use(['table','laydate'], function(){
        ...
        tableIns = table.render({
            elem: '#demo'
            ,url: BASE_URL + '/industryDistributionController/getEntByTzly'//数据接口
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'ratgro',width:'7%', title: '纳税额(万元)',sort:'true'}
        ...
        $("#exports").click(function () {
            ...
            doData(BASE_URL + '/industryDistributionController/exportsEntByTzly',params,function (result) {
                if(result.status = "10001"){
                    var exportData=result.data;
                    exportData.unshift({ENTNAME: '企业名称',CODE_NAME:'国民经济行业分类',AREA_NAME:'所属区域',REGCAP:'注册资金(万元)',ESTDATES:'成立日期',ratgro:'纳税额（万元）',ENTTYPE_CN:'企业类型',UNISCID: '统一社会信用代码'});
