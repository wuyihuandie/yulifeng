...
// create by zcy 2016/10/10
	...
	function runCircle(settings){
		 var defaultSetting={ 
			...
			circleBottomColor:"#105375",//圆环底色
            outerColorStart:'#0a2d55',  //外部圆环 渐变色
			outerColorMid:'#0e6088',
			outerColorEnd:'#009afb',
			innerColorStart:'#0ee1ef',  //内部圆环 渐变色
			innerColorEnd:'#06baf6'
		  }; 
		...
		function CanvasApp(){
			...
			function drawScreen(){
				...
				gradient1.addColorStop(0.5,outerColorMid);
